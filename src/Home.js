        ...
        <div className={classes.root}>
            <AppBar position="fixed" color="inherit" className={classes.appBar}>
                ...
                <Toolbar  >
                    ...
                    <img src={theme.palette.type === 'dark' ? '/images/branco.png' : '/images/preto.png'} alt="logo dark" className={classes.logo} />
            ...
            <Box display='flex'>
                        ...
                        <div className={classes.drawerContainer}>
                            <List>
                                <ListItem button classes={{
                                    ...
                                    <ListItemText primary={'Inicio'} classes={{
                ...
                <Box p={8}>
                    ...
                    <Typography
                        variant='h5'
                        color='textPrimary'
                        style={{ fontWeight: 800, paddingBottom : 5 }}
                    >
                        Recomendados
                </Typography>
